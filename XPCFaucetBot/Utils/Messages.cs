...
なお<#447671198566973480>はボランティアの方が回答する場合もありますので、お手数ですが質問の際は「何が起きていて、何で困っているのか」を記載頂けると助かります。";
        ...
        internal const string SignMessageReturnText = @"{0} 🈲 ここでmessage signコマンドは使わないでください 🈲

sign messageは個人の証明に使うコマンドですので、<@441117179405008897>へのDM専用となっています。
ここで!xp message signコマンドを打っても無効です。
